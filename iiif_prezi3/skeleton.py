...
#   timestamp: 2026-05-06T10:30:58+00:00
...
class AbstractIIIFResource(
    ...
    ] = Field(..., title='AbstractIIIFResource')
...
class Annotation(Base):
    ...
    target: Optional[Union[AnnoTarget, List[AnnoTarget]]] = None
...
class AnnotationPage(Class):
    ...
    partOf: Optional[List[AnnotationCollection]] = None
    next: Optional[AnnotationPageRef] = None
...
class AnnoTarget(RootModel[Union['AnyUrl', 'SpecificResource', 'CanvasRef', 'ManifestRef']]):
    root: Union[AnyUrl, SpecificResource, CanvasRef, ManifestRef]
...
class Reference(Base):
    ...
    id: Id
    label: Optional[LngString] = None
    type: constr(pattern=r'^Manifest$|^AnnotationPage$|^Collection$|^Canvas$|^Range$')
    thumbnail: Optional[List[Resource]] = None
